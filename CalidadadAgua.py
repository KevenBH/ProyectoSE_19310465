...
class Ventana(Frame):
	...
	def evaluar(self):
		...
		tma = int(self.tempAmbiente.get('1.0', END))
		tmm = int(self.tempMuestra.get('1.0', END))
		...
		messagebox.showinfo("Resultado", "La calidad del agua es: " + calidad.upper())
		clips.Eval("(clear)")
		g = Graficas()
